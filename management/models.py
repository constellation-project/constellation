...
class ManagedInterface(models.Model):
    ...
    a_records = models.ManyToManyField('dnsmanager.AddressRecord', blank=True, related_name='+', verbose_name=_("A records"))
    aaaa_records = models.ManyToManyField('dnsmanager.Ipv6AddressRecord', blank=True, related_name='+', verbose_name=_("AAAA records"))
    cname_records = models.ManyToManyField('dnsmanager.CanonicalNameRecord', blank=True, related_name='+', verbose_name=_("CNAME records"))
    ptr_records = models.ManyToManyField('dnsmanager.PointerRecord', blank=True, related_name='+', verbose_name=_("PTR records"))
